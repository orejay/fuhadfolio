...
const Intro = () => {
  return (
    <div className="w-11/12 lg:w-10/12 h-screen mx-auto flex flex-col-reverse lg:flex">
      <div className="lg:w-1/2 flex flex-col justify-center">
        ...
        <div className="lg:flex" style={{ color: "#BFC6D9" }}>
          <Link className="flex mr-8 mb-1 lg:mb-0 lg:text-base text-sm items-center">
      ...
      <div className="lg:w-1/2 flex justify-center items-center mb-4">
        <img src={ope} alt="ope" className="lg:w-6/12" />
      </div>
    </div>
  );
};
